# Estratégias e Funis de Crescimento

## O Que Colocar Aqui
- Diagramas de funil de vendas (AARRR, etc.)
- Mapeamento de jornadas de usuário (Customer Journey)
- Estruturas de campanhas (Nomenclaturas, Objetivos)
- Definições de públicos-alvo (Avatares/Personas)
...
```markdown
## [Nome da Campanha / Funil]

- **Objetivo Principal:** [Ex: Geração de Leads / Vendas Diretas]
- **Público-Alvo (Avatar):** [Ex: Empreendedores de 25-45 anos interessados em tecnologia]
- **Orçamento Diário Estimado:** [Ex: R$ 100/dia]
